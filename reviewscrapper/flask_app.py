    ...
    if request.method == 'POST':
        ...
        try:
            ...
            dbConn = pymongo.MongoClient(
                "mongodb+srv://geetha:krishna108@testcluster0.epqiq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
            db = dbConn.test
            #Database
            db = dbConn.get_database('crawlerDB') #connecting to the database called crawlerDB
            #Table
            #print(db)
            ...
            if reviews.count() > 0: # if there is a collection with searched keyword and it has records in it
                ...
                commentboxes = prod_html.find_all('div', {'class': "row _3AjFsn _2c2kV-"}) # finding the HTML section containing the customer comments
                print(commentboxes)
